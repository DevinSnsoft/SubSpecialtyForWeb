...
//		System.out.println(savePath);
		String filename ="沈阳农业大学本科生大类招生确定专业申请表.xls";
		String saveFileName = generateFileName(filename);
//		System.out.println(saveFileName);
		String savepath = generateSavePath(this.getServletContext().getRealPath("/WEB-INF/temp_student"),saveFileName);
		
		File f = new File(savepath+"\\"+saveFileName);	
//		String filename = "D://沈阳农业大学本科生大类招生确定专业申请表.xls";
...
//		response.getWriter().write("Loading Success,,,Please see D disk!");
		/*
		response.setContentType("application/octet-stream");
		response.setContentType("application/OCTET-STREAM;charset=UTF-8");
		String fileName1 = "沈阳农业大学本科生大类招生确定专业申请表.xls";
